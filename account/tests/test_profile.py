...
class AccountViewTests(TestCase):
    ...
    def test_password_expiry(self):
        ...
        self.assertRedirects(resp, reverse('account:rattic_change_password'), status_code=302, target_status_code=200)
    ...
    def test_change_password(self):
        ...
        response = self.client.get(reverse('account:rattic_change_password'))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(
            reverse('account:rattic_change_password'),
            post,
            follow=True,
        )
